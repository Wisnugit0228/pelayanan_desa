...
<form action="/lihatsuratlahir" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-xl-12 " style="display: none">
                    <input type="text" class="form-control" name="jenis" id="jenis" value="surat keterangan kelahiran" >
                </div>
