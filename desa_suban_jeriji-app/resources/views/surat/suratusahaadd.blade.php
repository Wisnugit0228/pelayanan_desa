...
@section('title')
    Form Permintaan Surat Usaha
@endsection


@section('konten')

<form action="/lihatsuratusaha" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <center>
                    Form Permintaan Surat Keterangan Usaha
                </center>
              </div>
            <div class="card-body">
                ...
                <div class="form-group col-xl-12" style="display: none">
                    <input type="text" class="form-control" id="jenis" value="surat keterangan usaha" >
                </div>
