...
<form action="/pelengkapsuratrekomendasi" method="POST" enctype="multipart/form-data">
    @csrf
    @method('GET')
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-xl-12">
                    <label for="foto1" class="form-label">Upload KTP/Kartu Pelajar</label><label for="" style="color: red">*</label>
