<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Suban Jeriji <sup>2</sup></div>
    </a>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/surat/daftarsurat">
            <i class="">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/pengaduanmasyarakat">
            <i class="">
    ...
    <li class="nav-item active">
        ...
        @endphp
        @if ($notifktp > 0)
         <span>Verifikasi KTP</span>  <span class="right badge badge-danger">{{ $notifktp }}</span>
        @else
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/permintaansuratadmin">
            <i class="">
            ...
            @endphp
            @if ($notifsurat > 0)
             <span>Permintaan Surat</span>  <span class="right badge badge-danger"> {{ $notifsurat }}</span>
            @else
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/pengaduanadmin">
            <i class="">
        ...
        @endphp
        @if ($pengaduan > 0)
          <span>Pengaduan</span> <span class="right badge badge-danger">{{ $pengaduan }}</span>
        @else
          <span>Pengaduan</span>
        @endif
            </a>
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/semuasuratkeluar">
            <i class="">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="/riwayatpengaduan">
            <i class="">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-lg" viewBox="0 0 16 16">
                    <path d="m9.708 6.075-3.024.379-.108.502.595.108c.387.093.464.232.38.619l-.975 4.577c-.255 1.183.14 1.74 1.067 1.74.72 0 1.554-.332 1.933-.789l.116-.549c-.263.232-.65.325-.905.325-.363 0-.494-.255-.402-.704l1.323-6.208Zm.091-2.755a1.32 1.32 0 1 1-2.64 0 1.32 1.32 0 0 1 2.64 0Z"/>
                  </svg>
