...
<form action="/lihatsurattidakmampu/{{ $tidak->id }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('put')
  ...
  <div class="form-group col-xl-6 col-lg-8">
    ...
    <div class="form-group col-xl-6 col-lg-8" style="display: none">
        <input type="text" class="form-control" name="profile_id" id="profile_id" value="{{ $tidak->profile_id }}" >
    </div>
    ...
    <div class="form-group col-xl-6 col-lg-8" style="display: none">
        <input type="text" class="form-control" name="jenis" id="jenis" value="surat keterangan tidak mampu" >
    </div>
