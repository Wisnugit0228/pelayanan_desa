        ...
        <td >
          ...
          @else
            @if ($item->status === "gagal")
              ...
              <a href="/lihatsurattidakmampu/{{ $item->id }}/edit" class="btn btn-sm" style="background-color: orange">Ulangi</a>
            @else
              <a href="/cetaksurattidakmampu/{{ $item->id }}" ><button type="button" class="btn btn-sm" style="background-color: orange">
                <i>
...
<div class="card">
  <div class="card-body">
      ...
      <a href="/lihatsurattidakmampu/create" >
