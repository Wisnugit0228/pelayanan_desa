...
<div>
  <a href="/lihatsuratpengantarktp/create" >
        ...
        <td >
          ...
          @else
            @if ($item->status === "gagal")
              ...
              <a href="/lihatsuratpengantarktp/{{ $item->id }}/edit" class="btn btn-sm" style="background-color: orange">Ulangi</a>
            @else
              <a href="/cetaksuratpengantarktp/{{ $item->id }}" ><button type="button" class="btn btn-sm" style="background-color: orange">
                <i>
