...
@section('title')
    Form Permintaan Surat Pengantar KTP
@endsection

@section('konten')

<form action="/lihatsuratpengantarktp" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group col-xl-12">
                    <label for="ttl">Tanggal Lahir</label><label for="" style="color: red">*</label>
                    <input type="date" class="form-control" name="ttl" id="ttl" max="{{ $mytime->format('Y-m-d') }}"  placeholder="masukan ttl">
                    @error('ttl')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group col-xl-12" style="display: none">
                    <input type="text" class="form-control" name="jenis" id="jenis" value="surat pengantar KTP" >
                </div>
