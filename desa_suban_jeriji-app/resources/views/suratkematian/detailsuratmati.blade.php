...
<body>
    <center>
        ...
        <table border="0" width="625">
            <tr>
                <td>Nama</td>
                <td width="450">: {{ $mati->nama }}</td>
            </tr>
            <tr>
                <td>NIK</td>
                <td width="450">: {{ $mati->nik }}</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td width="450">: {{ $mati->gender }}</td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td width="450">: {{ $mati->kerja }}</td>
            </tr>
            <tr>
                <td>Agama</td>
                <td width="450">: {{ $mati->agama }}</td>
            </tr>
          
            <tr>
                <td>Warganegara</td>
                <td width="450">: {{ $mati->warga }}</td>
            </tr>
            <tr>
                <td>Status Pernikahan</td>
                <td width="450">: {{ $mati->nikah }}</td>
            </tr>
        ...
        <table border="0" width="625">
            <tr>
                <td width="380"></td>
                <td>
                    SUBAN JERIJI, {{ $mati->created_at }}<br>
        ...
        <br>
        <a href="/cetaksuratkematian/{{ $mati->id }}" class="btn" style="background-color: orange">
            <i>
