...
@section('title')
    Daftar Surat Keterangan Kematian
@endsection
        ...
        <td >
          ...
          @else
            @if ($item->status === "gagal")
              ...
              <a href="/lihatsuratmati/{{ $item->id }}/edit" class="btn btn-sm" style="background-color: orange">Ulangi</a>
            @else
              <a href="/cetaksuratkematian/{{ $item->id }}" ><button type="button" class="btn btn-sm" style="background-color: orange">
                <i>
