...
<head>
    ...
    <title>Suban Jeriji - Register</title>
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block"><img src="images/logome.png" width="400" alt=""></div>
                    <div class="col-lg-7">
                        <div class="p-5">
                                ...
                                @csrf
                                    ...
                                    <div class="form-grup mb-3">
                                        <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror" 
                                            name="name" value="{{ old('name') }}" required autocomplete="name" autofocus id="username"
