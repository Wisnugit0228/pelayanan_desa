    ...
    <center>
        ...
        <table border="0" width="625">
            <tr>
                <td>
                    <center>
                        <font size="4"><b><u>SURAT PENGANTAR KK</u></b></font><br>
        ...
        <table border="0" width="625">
            <tr>
                <td>Nama</td>
                <td width="450">: {{ $kk->nama }}</td>
            </tr>
            <tr>
                <td>Tempat, Tanggal Lahir</td>
                <td width="450">: {{ $kk->tempat }}, {{ $kk->ttl }}</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td width="450">: {{ $kk->gender }}</td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td width="450">: {{ $kk->kerja }}</td>
            </tr>
            <tr>
                <td>Warganegara/Agama</td>
                <td width="450">: {{ $kk->warga }}/{{ $kk->agama }}</td>
            </tr>
          
            <tr>
                <td>Alamat</td>
                <td width="450">: {{ $kk->alamat }}</td>
            </tr>
            ...
            <tr>
                <td>
                    <p>Orang tersebut diatas, memang benar adalah warga Desa Suban Jeriji Kecamatan Rambang Niru, 
                        surat ini dibuat guna melengkapi syarat pembuatan atau pengurusan KK (Kartu Keluarga).
                    </p>
