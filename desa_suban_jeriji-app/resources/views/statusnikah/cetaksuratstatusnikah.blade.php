    ...
    <center>
        ...
        <table border="0" width="19.5cm">
            <tr>
                <td>
                    <center>
                        <font size="4"><b><u>SURAT KETERANGAN JANDA/DUDA</u></b></font><br>
        ...
        <table border="0" width="19.5cm">
            <tr>
                <td>Nama</td>
                <td width="400">: {{ $nikah->nama }}</td>
            </tr>
            <tr>
                <td>NIK</td>
                <td width="400">: {{ $nikah->nik }}</td>
            </tr>
            <tr>
                <td>Tempat, Tanggal Lahir</td>
                <td width="400">: {{ $nikah->tempat }}, {{ $nikah->ttl }}</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td width="400">: {{ $nikah->gender }}</td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td width="400">: {{ $nikah->kerja }}</td>
            </tr>
            <tr>
                <td>Warganegara/Agama</td>
                <td width="400">: {{ $nikah->warga }}/{{ $nikah->agama }}</td>
            </tr>
            <tr>
                <td>Status Pernikahan</td>
                <td width="400">: {{ $nikah->dokumen->statusnikah }}</td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td width="400">: {{ $nikah->alamat }}</td>
            </tr>
