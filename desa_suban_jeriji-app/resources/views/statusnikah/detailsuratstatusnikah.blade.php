...
@section('title')
    Detail Surat Keterangan Janda/Duda
@endsection
...
<body>
    <center>
            ...
            <tr>
                <td>
                    <center>
                        ...
                        <font size="2">Nomor: {{ $nikah->nomor }}</font>
        ...
        <table border="0" width="625">
            <tr>
                <td>Nama</td>
                <td width="450">: {{ $nikah->nama }}</td>
            </tr>
            <tr>
                <td>NIK</td>
                <td width="450">: {{ $nikah->nik }}</td>
            </tr>
            <tr>
                <td>Tempat, Tanggal Lahir</td>
                <td width="450">: {{ $nikah->tempat }}, {{ $nikah->ttl }}</td>
            </tr>
            <tr>
                <td>Jenis Kelamin</td>
                <td width="450">: {{ $nikah->gender }}</td>
            </tr>
            <tr>
                <td>Pekerjaan</td>
                <td width="450">: {{ $nikah->kerja }}</td>
            </tr>
            <tr>
                <td>Warganegara/Agama</td>
                <td width="450">: {{ $nikah->warga }}/{{ $nikah->agama }}</td>
            </tr>
            <tr>
                <td>Status</td>
                <td width="450">: {{ $nikah->dokumen->statusnikah }}</td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td width="450">: {{ $nikah->alamat }}</td>
            </tr>
        ...
        <table border="0" width="625">
            <tr>
                <td>
                    <p>
                        Menyatakan dengan sebenarnya bahwa Orang tersebut diatas, 
                        memang benar adalah warga Desa Suban Jeriji Kecamatan Rambang Niru, dengan status
                        {{ $nikah->dokumen->statusnikah }} {{ $nikah->nikah }} dan belum menikah lagi.
                    </p>
        ...
        <table border="0" width="625">
            <tr>
                <td width="380"></td>
                <td>
                    SUBAN JERIJI,  {{ $nikah->created_at }}<br>
        ...
        <br>
        <a href="/cetaksuratketerangannikah/{{ $nikah->id }}" class="btn" style="background-color: orange">
            <i>
