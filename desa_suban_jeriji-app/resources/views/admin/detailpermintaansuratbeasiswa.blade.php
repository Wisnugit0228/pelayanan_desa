...
<div class="container">
    <div class="row">
      ...
      <form action="/permintaansuratrekomendasiadmin/{{ $data->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="form-group col-xl-6 col-lg-8" style="display: none">
            ...
            <input type="text" class="form-control" name="nomor" id="nomor"  value="213/00{{ ($max->no+1) }}/SBJ/XII/2023">
