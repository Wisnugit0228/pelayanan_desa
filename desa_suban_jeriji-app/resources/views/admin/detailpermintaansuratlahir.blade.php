...
@section('title')
    Detail Permintaan Surat Keterangan Kelahiran
@endsection

@section('konten')


<h3 style="text-align: center">Data Permintaan Surat Ketterangan Kelahiran:</h3>
<div class="container">
    <div class="row">
        <div class="col-lg-3">
            <img src="/ktp/{{ $lahir->dokumen->foto }}" class="img-thumbnail" alt="..."><br>
        ...
        <div class="col-lg-9">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>{{ $lahir->dokumen->namaayah }}</td>
                </tr>
                <tr>
                    <th width="200">Nama Ibu</th>
                    <td>{{ $lahir->dokumen->namaibu }}</td>
                </tr>
              </table>
      ...
      <form action="/permintaansuratlahiradmin/{{ $lahir->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="form-group col-xl-6 col-lg-8" style="display: none">
            ...
            <input type="text" class="form-control" name="nomor" id="nomor"  value="208/00{{ ($max->no+1) }}/SBJ/XII/2023">
