...
@section('title')
    Detail Permintaan Surat Pengantar KTP
@endsection

@section('konten')


<h3 style="text-align: center">Data Permintaan Surat Pengantar KTP:</h3>
<div class="container">
    <div class="row">
        <div class="col-lg-3">
            <h6>Foto Diri:</h6>
            <img src="/fotoprofile/{{ $data->dokumen->foto }}" class="img-thumbnail" alt="..."><br>
            <h6>Foto Kartu Keluarga:</h6>
            <img src="/fotopelengkap/{{ $data->dokumen->foto1 }}" class="img-thumbnail" alt="..."><br>
            <h6>Foto Akta Lahir:</h6>
            <img src="/fotopelengkap/{{ $data->dokumen->foto2 }}" class="img-thumbnail" alt="..."><br>
        </div>
        <div class="col-lg-9">
      ...
      <form action="/permintaansuratpengantarktpadmin/{{ $data->id }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="form-group col-xl-6 col-lg-8" style="display: none">
            ...
            <input type="text" class="form-control" name="nomor" id="nomor"  value="210/00{{ ($max->no+1) }}/SBJ/XII/2023">
