...
<table class="table table-striped">
  ...
  <tbody>
    @forelse ($suratdomisili as $no => $item)
    <tr>
        
        <td>{{ $item->profile->nama }}</td>
        <td>{{ $item->profile->nik }}</td>
        <td>{{ $item->profile->tempat }}, {{ $item->profile->ttl }}</td>
        <td>{{ $item->jenis }}</td>
        <td >
          ...
          @else
            @if ($item->status === "gagal")
              ...
              <a href="/lihatsuratdomisili/{{ $item->id }}/edit" class="btn btn-sm" style="background-color: orange">Ulangi</a>
            @else
              <a href="/cetaksuratdomisili/{{ $item->id }}" ><button type="button" class="btn btn-sm" style="background-color: orange">
                <i>
...
<div class="card">
  <div class="card-body">
      ...
      <a href="/lihatsuratdomisili/create" >
