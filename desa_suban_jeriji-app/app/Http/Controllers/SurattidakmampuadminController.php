...
class SurattidakmampuadminController extends Controller
{
    /**
    ...
    {
        $max = Surat::get()->where('jenis', 'surat keterangan tidak mampu')->where('status', 'sukses')->last();
        $tidakmampu = Surat::get()->where('id', $id)->first();
        // $category = Ktp::get();

        return view('admin.detailpermintaansurattidakmampu', ['tidakmampu'=>$tidakmampu], ['max'=>$max]);
    }
